...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      headerPanel(""),
      h4("Instrucciones"),
      p("1) Cargar un archivo .csv con al menos las siguientes columnas:",
      ...
      p("2) Cargar un archivo con secuencias en formato .fasta o .fas"),
      p("3) Nombres en ambos archivos deben coincidir exactamente (preferiblemente sin símbolos o espacio, se puede usar guión bajo"),
      p("4) El archivo estará listo para descargar luego de que carquen los dos archivos"),
      headerPanel(""),
    ...
    mainPanel(
      ...
      p("Esta aplicación facilita la creación de archivos de entrada para el programa ",
      ...
      p(em("Nota 1"), ": las coordenadas de la polaciones (o traits) son calculadas como el centroide o el punto medio."),
      p(em("Nota 2"), ": esta aplicación está hecha para casos particulares y podría generar erroes para casos no probados durante su desarrollo. ",
        "Por lo tanto debe revisar detalladamente si el archivo generado contiene la estructura esperada."),
      p(em("Nota 3"), ": esta versión no incorpora la posibilidad de añadir un bloque con los árboles para inferir redes de parsimonia ancestral."),
      headerPanel(""),
