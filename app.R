...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p(style="text-align: justify;",
        "3) Los nombres de las secuencias en ambos archivos deben coincidir exactamente (preferiblemente sin símbolos o espacio, se puede usar guión bajo)"),
      p(style="text-align: justify;",
    ...
    mainPanel(
      ...
      p(style="text-align: justify;",
        em("Nota 3"), ": en caso de no querer ingresar las coordenadas se deben incluir las columnas lat y lon vacías, de lo contrario generará un error. Luego de generado el archivo deberá eliminar el bloque GeoTags."),
      p(style="text-align: justify;",
